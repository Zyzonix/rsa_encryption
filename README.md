...
* Java 14 (JDK 14)
* just download [this](https://github.com/Zyzonix/rsa_encryption/blob/main/compiled_jar/rsa_calculation.jar?raw=true) [/compiled_jar/rsa_encryption.jar](../three/main/compiled_jar/rsa_encryption.jar) then open terminal/cmd and type:
```
